...
//텍스쳐
LPDIRECT3DTEXTURE9 gpEarhDM = NULL;
...
{
	// 텍스쳐 로딩
	gpEarhDM = LoadTexture("Earth.jpg");

	// 쉐이더 로딩
	gpLightingShader = LoadShader("EarthLighting.fx");
...
void RenderScene()
{
	...
	gpLightingShader->SetTexture("DiffuseMap_Tex", gpEarhDM);
